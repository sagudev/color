...
pub const ALICE_BLUE: AlphaColor<Srgb> = AlphaColor::from_rgba8(240, 248, 255, 255);
...
pub const ANTIQUE_WHITE: AlphaColor<Srgb> = AlphaColor::from_rgba8(250, 235, 215, 255);
...
pub const AQUA: AlphaColor<Srgb> = AlphaColor::from_rgba8(0, 255, 255, 255);
...
pub const AQUAMARINE: AlphaColor<Srgb> = AlphaColor::from_rgba8(127, 255, 212, 255);
...
pub const AZURE: AlphaColor<Srgb> = AlphaColor::from_rgba8(240, 255, 255, 255);
...
pub const BEIGE: AlphaColor<Srgb> = AlphaColor::from_rgba8(245, 245, 220, 255);
...
pub const BISQUE: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 228, 196, 255);
...
pub const BLACK: AlphaColor<Srgb> = AlphaColor::from_rgba8(0, 0, 0, 255);
...
pub const BLANCHED_ALMOND: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 235, 205, 255);
...
pub const BLUE: AlphaColor<Srgb> = AlphaColor::from_rgba8(0, 0, 255, 255);
...
pub const BLUE_VIOLET: AlphaColor<Srgb> = AlphaColor::from_rgba8(138, 43, 226, 255);
...
pub const BROWN: AlphaColor<Srgb> = AlphaColor::from_rgba8(165, 42, 42, 255);
...
pub const BURLYWOOD: AlphaColor<Srgb> = AlphaColor::from_rgba8(222, 184, 135, 255);
...
pub const CADET_BLUE: AlphaColor<Srgb> = AlphaColor::from_rgba8(95, 158, 160, 255);
...
pub const CHARTREUSE: AlphaColor<Srgb> = AlphaColor::from_rgba8(127, 255, 0, 255);
...
pub const CHOCOLATE: AlphaColor<Srgb> = AlphaColor::from_rgba8(210, 105, 30, 255);
...
pub const CORAL: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 127, 80, 255);
...
pub const CORNFLOWER_BLUE: AlphaColor<Srgb> = AlphaColor::from_rgba8(100, 149, 237, 255);
...
pub const CORNSILK: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 248, 220, 255);
...
pub const CRIMSON: AlphaColor<Srgb> = AlphaColor::from_rgba8(220, 20, 60, 255);
...
pub const CYAN: AlphaColor<Srgb> = AlphaColor::from_rgba8(0, 255, 255, 255);
...
pub const DARK_BLUE: AlphaColor<Srgb> = AlphaColor::from_rgba8(0, 0, 139, 255);
...
pub const DARK_CYAN: AlphaColor<Srgb> = AlphaColor::from_rgba8(0, 139, 139, 255);
...
pub const DARK_GOLDENROD: AlphaColor<Srgb> = AlphaColor::from_rgba8(184, 134, 11, 255);
...
pub const DARK_GRAY: AlphaColor<Srgb> = AlphaColor::from_rgba8(169, 169, 169, 255);
...
pub const DARK_GREEN: AlphaColor<Srgb> = AlphaColor::from_rgba8(0, 100, 0, 255);
...
pub const DARK_KHAKI: AlphaColor<Srgb> = AlphaColor::from_rgba8(189, 183, 107, 255);
...
pub const DARK_MAGENTA: AlphaColor<Srgb> = AlphaColor::from_rgba8(139, 0, 139, 255);
...
pub const DARK_OLIVE_GREEN: AlphaColor<Srgb> = AlphaColor::from_rgba8(85, 107, 47, 255);
...
pub const DARK_ORANGE: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 140, 0, 255);
...
pub const DARK_ORCHID: AlphaColor<Srgb> = AlphaColor::from_rgba8(153, 50, 204, 255);
...
pub const DARK_RED: AlphaColor<Srgb> = AlphaColor::from_rgba8(139, 0, 0, 255);
...
pub const DARK_SALMON: AlphaColor<Srgb> = AlphaColor::from_rgba8(233, 150, 122, 255);
...
pub const DARK_SEA_GREEN: AlphaColor<Srgb> = AlphaColor::from_rgba8(143, 188, 143, 255);
...
pub const DARK_SLATE_BLUE: AlphaColor<Srgb> = AlphaColor::from_rgba8(72, 61, 139, 255);
...
pub const DARK_SLATE_GRAY: AlphaColor<Srgb> = AlphaColor::from_rgba8(47, 79, 79, 255);
...
pub const DARK_TURQUOISE: AlphaColor<Srgb> = AlphaColor::from_rgba8(0, 206, 209, 255);
...
pub const DARK_VIOLET: AlphaColor<Srgb> = AlphaColor::from_rgba8(148, 0, 211, 255);
...
pub const DEEP_PINK: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 20, 147, 255);
...
pub const DEEP_SKY_BLUE: AlphaColor<Srgb> = AlphaColor::from_rgba8(0, 191, 255, 255);
...
pub const DIM_GRAY: AlphaColor<Srgb> = AlphaColor::from_rgba8(105, 105, 105, 255);
...
pub const DODGER_BLUE: AlphaColor<Srgb> = AlphaColor::from_rgba8(30, 144, 255, 255);
...
pub const FIREBRICK: AlphaColor<Srgb> = AlphaColor::from_rgba8(178, 34, 34, 255);
...
pub const FLORAL_WHITE: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 250, 240, 255);
...
pub const FOREST_GREEN: AlphaColor<Srgb> = AlphaColor::from_rgba8(34, 139, 34, 255);
...
pub const FUCHSIA: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 0, 255, 255);
...
pub const GAINSBORO: AlphaColor<Srgb> = AlphaColor::from_rgba8(220, 220, 220, 255);
...
pub const GHOST_WHITE: AlphaColor<Srgb> = AlphaColor::from_rgba8(248, 248, 255, 255);
...
pub const GOLD: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 215, 0, 255);
...
pub const GOLDENROD: AlphaColor<Srgb> = AlphaColor::from_rgba8(218, 165, 32, 255);
...
pub const GRAY: AlphaColor<Srgb> = AlphaColor::from_rgba8(128, 128, 128, 255);
...
pub const GREEN: AlphaColor<Srgb> = AlphaColor::from_rgba8(0, 128, 0, 255);
...
pub const GREEN_YELLOW: AlphaColor<Srgb> = AlphaColor::from_rgba8(173, 255, 47, 255);
...
pub const HONEYDEW: AlphaColor<Srgb> = AlphaColor::from_rgba8(240, 255, 240, 255);
...
pub const HOT_PINK: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 105, 180, 255);
...
pub const INDIAN_RED: AlphaColor<Srgb> = AlphaColor::from_rgba8(205, 92, 92, 255);
...
pub const INDIGO: AlphaColor<Srgb> = AlphaColor::from_rgba8(75, 0, 130, 255);
...
pub const IVORY: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 255, 240, 255);
...
pub const KHAKI: AlphaColor<Srgb> = AlphaColor::from_rgba8(240, 230, 140, 255);
...
pub const LAVENDER: AlphaColor<Srgb> = AlphaColor::from_rgba8(230, 230, 250, 255);
...
pub const LAVENDER_BLUSH: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 240, 245, 255);
...
pub const LAWN_GREEN: AlphaColor<Srgb> = AlphaColor::from_rgba8(124, 252, 0, 255);
...
pub const LEMON_CHIFFON: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 250, 205, 255);
...
pub const LIGHT_BLUE: AlphaColor<Srgb> = AlphaColor::from_rgba8(173, 216, 230, 255);
...
pub const LIGHT_CORAL: AlphaColor<Srgb> = AlphaColor::from_rgba8(240, 128, 128, 255);
...
pub const LIGHT_CYAN: AlphaColor<Srgb> = AlphaColor::from_rgba8(224, 255, 255, 255);
...
pub const LIGHT_GOLDENROD_YELLOW: AlphaColor<Srgb> = AlphaColor::from_rgba8(250, 250, 210, 255);
...
pub const LIGHT_GRAY: AlphaColor<Srgb> = AlphaColor::from_rgba8(211, 211, 211, 255);
...
pub const LIGHT_GREEN: AlphaColor<Srgb> = AlphaColor::from_rgba8(144, 238, 144, 255);
...
pub const LIGHT_PINK: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 182, 193, 255);
...
pub const LIGHT_SALMON: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 160, 122, 255);
...
pub const LIGHT_SEA_GREEN: AlphaColor<Srgb> = AlphaColor::from_rgba8(32, 178, 170, 255);
...
pub const LIGHT_SKY_BLUE: AlphaColor<Srgb> = AlphaColor::from_rgba8(135, 206, 250, 255);
...
pub const LIGHT_SLATE_GRAY: AlphaColor<Srgb> = AlphaColor::from_rgba8(119, 136, 153, 255);
...
pub const LIGHT_STEEL_BLUE: AlphaColor<Srgb> = AlphaColor::from_rgba8(176, 196, 222, 255);
...
pub const LIGHT_YELLOW: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 255, 224, 255);
...
pub const LIME: AlphaColor<Srgb> = AlphaColor::from_rgba8(0, 255, 0, 255);
...
pub const LIME_GREEN: AlphaColor<Srgb> = AlphaColor::from_rgba8(50, 205, 50, 255);
...
pub const LINEN: AlphaColor<Srgb> = AlphaColor::from_rgba8(250, 240, 230, 255);
...
pub const MAGENTA: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 0, 255, 255);
...
pub const MAROON: AlphaColor<Srgb> = AlphaColor::from_rgba8(128, 0, 0, 255);
...
pub const MEDIUM_AQUAMARINE: AlphaColor<Srgb> = AlphaColor::from_rgba8(102, 205, 170, 255);
...
pub const MEDIUM_BLUE: AlphaColor<Srgb> = AlphaColor::from_rgba8(0, 0, 205, 255);
...
pub const MEDIUM_ORCHID: AlphaColor<Srgb> = AlphaColor::from_rgba8(186, 85, 211, 255);
...
pub const MEDIUM_PURPLE: AlphaColor<Srgb> = AlphaColor::from_rgba8(147, 112, 219, 255);
...
pub const MEDIUM_SEA_GREEN: AlphaColor<Srgb> = AlphaColor::from_rgba8(60, 179, 113, 255);
...
pub const MEDIUM_SLATE_BLUE: AlphaColor<Srgb> = AlphaColor::from_rgba8(123, 104, 238, 255);
...
pub const MEDIUM_SPRING_GREEN: AlphaColor<Srgb> = AlphaColor::from_rgba8(0, 250, 154, 255);
...
pub const MEDIUM_TURQUOISE: AlphaColor<Srgb> = AlphaColor::from_rgba8(72, 209, 204, 255);
...
pub const MEDIUM_VIOLET_RED: AlphaColor<Srgb> = AlphaColor::from_rgba8(199, 21, 133, 255);
...
pub const MIDNIGHT_BLUE: AlphaColor<Srgb> = AlphaColor::from_rgba8(25, 25, 112, 255);
...
pub const MINT_CREAM: AlphaColor<Srgb> = AlphaColor::from_rgba8(245, 255, 250, 255);
...
pub const MISTY_ROSE: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 228, 225, 255);
...
pub const MOCCASIN: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 228, 181, 255);
...
pub const NAVAJO_WHITE: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 222, 173, 255);
...
pub const NAVY: AlphaColor<Srgb> = AlphaColor::from_rgba8(0, 0, 128, 255);
...
pub const OLD_LACE: AlphaColor<Srgb> = AlphaColor::from_rgba8(253, 245, 230, 255);
...
pub const OLIVE: AlphaColor<Srgb> = AlphaColor::from_rgba8(128, 128, 0, 255);
...
pub const OLIVE_DRAB: AlphaColor<Srgb> = AlphaColor::from_rgba8(107, 142, 35, 255);
...
pub const ORANGE: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 165, 0, 255);
...
pub const ORANGE_RED: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 69, 0, 255);
...
pub const ORCHID: AlphaColor<Srgb> = AlphaColor::from_rgba8(218, 112, 214, 255);
...
pub const PALE_GOLDENROD: AlphaColor<Srgb> = AlphaColor::from_rgba8(238, 232, 170, 255);
...
pub const PALE_GREEN: AlphaColor<Srgb> = AlphaColor::from_rgba8(152, 251, 152, 255);
...
pub const PALE_TURQUOISE: AlphaColor<Srgb> = AlphaColor::from_rgba8(175, 238, 238, 255);
...
pub const PALE_VIOLET_RED: AlphaColor<Srgb> = AlphaColor::from_rgba8(219, 112, 147, 255);
...
pub const PAPAYA_WHIP: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 239, 213, 255);
...
pub const PEACH_PUFF: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 218, 185, 255);
...
pub const PERU: AlphaColor<Srgb> = AlphaColor::from_rgba8(205, 133, 63, 255);
...
pub const PINK: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 192, 203, 255);
...
pub const PLUM: AlphaColor<Srgb> = AlphaColor::from_rgba8(221, 160, 221, 255);
...
pub const POWDER_BLUE: AlphaColor<Srgb> = AlphaColor::from_rgba8(176, 224, 230, 255);
...
pub const PURPLE: AlphaColor<Srgb> = AlphaColor::from_rgba8(128, 0, 128, 255);
...
pub const REBECCA_PURPLE: AlphaColor<Srgb> = AlphaColor::from_rgba8(102, 51, 153, 255);
...
pub const RED: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 0, 0, 255);
...
pub const ROSY_BROWN: AlphaColor<Srgb> = AlphaColor::from_rgba8(188, 143, 143, 255);
...
pub const ROYAL_BLUE: AlphaColor<Srgb> = AlphaColor::from_rgba8(65, 105, 225, 255);
...
pub const SADDLE_BROWN: AlphaColor<Srgb> = AlphaColor::from_rgba8(139, 69, 19, 255);
...
pub const SALMON: AlphaColor<Srgb> = AlphaColor::from_rgba8(250, 128, 114, 255);
...
pub const SANDY_BROWN: AlphaColor<Srgb> = AlphaColor::from_rgba8(244, 164, 96, 255);
...
pub const SEA_GREEN: AlphaColor<Srgb> = AlphaColor::from_rgba8(46, 139, 87, 255);
...
pub const SEASHELL: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 245, 238, 255);
...
pub const SIENNA: AlphaColor<Srgb> = AlphaColor::from_rgba8(160, 82, 45, 255);
...
pub const SILVER: AlphaColor<Srgb> = AlphaColor::from_rgba8(192, 192, 192, 255);
...
pub const SKY_BLUE: AlphaColor<Srgb> = AlphaColor::from_rgba8(135, 206, 235, 255);
...
pub const SLATE_BLUE: AlphaColor<Srgb> = AlphaColor::from_rgba8(106, 90, 205, 255);
...
pub const SLATE_GRAY: AlphaColor<Srgb> = AlphaColor::from_rgba8(112, 128, 144, 255);
...
pub const SNOW: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 250, 250, 255);
...
pub const SPRING_GREEN: AlphaColor<Srgb> = AlphaColor::from_rgba8(0, 255, 127, 255);
...
pub const STEEL_BLUE: AlphaColor<Srgb> = AlphaColor::from_rgba8(70, 130, 180, 255);
...
pub const TAN: AlphaColor<Srgb> = AlphaColor::from_rgba8(210, 180, 140, 255);
...
pub const TEAL: AlphaColor<Srgb> = AlphaColor::from_rgba8(0, 128, 128, 255);
...
pub const THISTLE: AlphaColor<Srgb> = AlphaColor::from_rgba8(216, 191, 216, 255);
...
pub const TOMATO: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 99, 71, 255);
...
pub const TURQUOISE: AlphaColor<Srgb> = AlphaColor::from_rgba8(64, 224, 208, 255);
...
pub const VIOLET: AlphaColor<Srgb> = AlphaColor::from_rgba8(238, 130, 238, 255);
...
pub const WHEAT: AlphaColor<Srgb> = AlphaColor::from_rgba8(245, 222, 179, 255);
...
pub const WHITE: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 255, 255, 255);
...
pub const WHITE_SMOKE: AlphaColor<Srgb> = AlphaColor::from_rgba8(245, 245, 245, 255);
...
pub const YELLOW: AlphaColor<Srgb> = AlphaColor::from_rgba8(255, 255, 0, 255);
...
pub const YELLOW_GREEN: AlphaColor<Srgb> = AlphaColor::from_rgba8(154, 205, 50, 255);
